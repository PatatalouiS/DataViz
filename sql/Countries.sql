...
INSERT INTO Countries VALUES
    ...
    (22,'Bhutan','Asie'),
    (23,'Bolivia (Plurin State of)','SouthAmerica'),
    ...
    (41,'China','Asie'),
    (42,'China Hong Kong SAR','Asie'),
    (43,'China Macao SAR','Asie'),
    ...
    (53,'Cyprus','Europe'),
    (54,'Czechia','Europe'),
    (55,'Dem People''s Rep Korea','Asie'),
    (56,'Dem Rep of the Congo','Africa'),
    (57,'Denmark','Europe'),
    (58,'Djibouti','Africa'),
    ...
    (66,'Estonia','Europe'),
    (67,'Ethiopia','Africa'),
    (68,'Falkland Islands (Malvinas)','SouthAmerica'),
    ...
    (93,'India','Asie'),
    (94,'Indonesia','Asie'),
    (95,'Iran (Islamic Republic of)','Asie'),
    (96,'Iraq','Asie'),
    (97,'Ireland','Europe'),
    (98,'Israel','Asie'),
    (99,'Italy','Europe'),
    ...
    (128,'Micronesia (Fed States of)','Oceania'),
    (129,'Mongolia','Asie'),
    ...
    (139,'Netherlands Antilles [former]','SouthAmerica'),
    ...
    (156,'Portugal','Europe'),
    (157,'Qatar','Asie'),
    (158,'Republic of Korea','Asie'),
    (159,'Republic of Moldova','Europe'),
    (160,'Réunion','Africa'),
    (161,'Romania','Europe'),
    ...
    (172,'Senegal','Africa'),
    (173,'Serbia','Europe'),
    (174,'Serbia and Monten [former]','Europe'),
    (175,'Seychelles','Africa'),
    (176,'Sierra Leone','Africa'),
    (177,'Singapore','Asie'),
    (178,'Sint Maarten (Dutch part)','NorthAmerica'),
    (179,'Slovakia','Europe'),
    (180,'Slovenia','Europe'),
    ...
    (188,'Sudan','Africa'),
    (189,'Sudan [former]','Africa'),
    (190,'Suriname','SouthAmerica'),
    (191,'Swaziland','Africa'),
    (192,'Sweden','Europe'),
    (193,'Switzerland','Europe'),
    (194,'Syrian Arab Republic','Asie'),
    (195,'Tajikistan','Asie'),
    (196,'TFYR of Macedonia','Europe'),
    (197,'Thailand','Asie'),
    ...
    (215,'Uzbekistan','Asie'),
    (216,'Vanuatu','Oceania'),
    (217,'Venezuela (Boliv Rep of)','SouthAmerica'),
    (218,'Viet Nam','Asie'),
